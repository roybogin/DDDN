...
class Trainer:
    def __init__(self, model, epochs, population_count, mutation_rate, max_iter, breed_percent):
    ...
    def breed(self):
        self.evaluate()
        best_cars = self.evaluations[:(int)(self.breed_percent * self.population_count)]
    ...
    def evaluate(self):
        self.evaluations= []
        for car in self.population:
            score = calculate_score(car)    # need to implement
