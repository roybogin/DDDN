...
def create_poly_wall(poly, epsilon):
	...
	for i in range(1, len(poly) - 1):
		...
		pos = [poly[i][0] + math.cos(angle) * (length / 2 + length_from), poly[i][1] + math.sin(angle) * (length / 2 + length_from), 0.5]
...
def main():
	...
	epsilon = 0.1
	create_poly_wall([(-1, 3), (0, 10), (1, 3), (10, 10), (3, 1), (10, 0), (3,-1), (10, -10), (1, -3), (0, -10), (-1, -3), (-10, -10), (-3, -1), (-10, 0), (-3, 1), (-10, 10), (-2, 4)], epsilon)
