...
size_map_quarter = 8    # half of the length of the map (represents quarter of the area)
vertex_offset = 0.11    # offset between vertices
map_borders = [     # borders of the map
...
calculate_action_time = 40  # maximum amount of steps to calculate a new action (velocity and wheel rotation)
calculate_d_star_time = 40  # maximum amount of steps to recalculate the d_star in case of edge removal
reset_count_time = 100      # maximum allowed of steps to reset the counter (and also choose a new target vertex)
